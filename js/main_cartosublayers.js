var satellite = L.tileLayer('https://api.mapbox.com/v4/{mapId}/{z}/{x}/{y}.png?access_token={token}', {
        // tileSize: 512,
...
cartodb.createLayer(mapObject, {
        ...
        type: 'cartodb',
        sublayers: [{
            sql: 'SELECT * FROM leaf_arecs2',
            cartocss: '#leaf_arecs2 { polygon-fill: #ce5142;polygon-opacity: 1; line-width: 25; line-color: #ce5142}'
        }]
}).addTo(mapObject)
    .done(function(layer) {
        ...
        // cdb.vis.Vis.addInfowindow(map, layer.getSubLayer(0), ['cartodb_id','id']);
...
//         }).addTo(mapObject).bindPopup("popup");
...
//                 pop = layer.bindPopup(feature.properties.ownershipmain.js);
...
//                     }
//
//                     // mapObject.setView(center,14,{animate: true});
//                     // console.log(bounds._northEast.lat - bounds._southWest.lat );
//                     var size = layer.feature.properties.size;
//                     var name = layer.feature.properties.arec_name;
//                     var image = "../img/photos/" + layer.feature.properties.photos;
...
//         labels = ['VT', 'VT Foundation', 'Leased from VT Foundation', 'Leased', 'Owned by VA Beach'];
//
